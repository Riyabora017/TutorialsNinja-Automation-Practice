...
public class TC_RF_001 {
	...
	//enter register page then fill credentials
		driver.findElement(By.id("input-firstname")).sendKeys("Riya");
		driver.findElement(By.id("input-lastname")).sendKeys("Bora");
         driver.findElement(By.id("input-email")).sendKeys(generateNewEmail());
         driver.findElement(By.id("input-telephone")).sendKeys("9311057796");
